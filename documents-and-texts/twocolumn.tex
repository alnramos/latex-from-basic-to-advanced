...
\usepackage{multicol}
% O pacote lscape permite deixar apenas parte do texto em modo Paisagem
\usepackage{lscape}
\linespread{1.5}

\begin{document}

% O pacote multicols permite dividir o documento ou parte do texto em múltiplas colunas
%\begin{multicols}{2}
\begin{center}
